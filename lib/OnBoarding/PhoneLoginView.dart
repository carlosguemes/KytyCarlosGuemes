...
class _PhoneLoginViewState extends State<PhoneLoginView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          PaddingClass(labelText: "Numero Telefono",controlador: tecPhone, esContrasenya: false),
          TextButton(onPressed: enviarTelefonoPressed, child: Text("Enviar")),
          if(blMostrarVerificacion)
            PaddingClass(labelText: "Numero Verificacion",controlador: tecVerify, esContrasenya: false),
          if(blMostrarVerificacion)
